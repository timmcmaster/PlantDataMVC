...
using SeedBatch = PlantData.Web.Mvc.Models.ViewModels.SeedBatch;
...
namespace PlantData.Web.Mvc.Mappers
{
    ...
    public class DataModelToUIMappingProfile : Profile
    {
        ...
        {
            // Genus
            CreateMap<GenusDataModel, GenusDeleteViewModel>()
               .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
               .ForMember(uio => uio.LatinName, opt => opt.MapFrom(dm => dm.LatinName));

            CreateMap<GenusDataModel, GenusEditViewModel>()
               .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
               .ForMember(uio => uio.LatinName, opt => opt.MapFrom(dm => dm.LatinName));

            CreateMap<GenusDataModel, GenusListViewModel>()
               .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
               .ForMember(uio => uio.LatinName, opt => opt.MapFrom(dm => dm.LatinName));


            CreateMap<GenusDataModel, GenusNewViewModel>()
               .ForMember(uio => uio.LatinName, opt => opt.MapFrom(dm => dm.LatinName));

            CreateMap<GenusDataModel, GenusShowViewModel>()
               .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
               .ForMember(uio => uio.LatinName, opt => opt.MapFrom(dm => dm.LatinName));
        }
        ...
        {
            // SpeciesDTO
            CreateMap<SpeciesDataModel, PlantDeleteViewModel>()
            ...
            CreateMap<SpeciesDataModel, PlantEditViewModel>()
               .ForMember(uio => uio.CommonName, opt => opt.MapFrom(dm => dm.CommonName))
               .ForMember(uio => uio.Description, opt => opt.MapFrom(dm => dm.Description))
            ...
            CreateMap<SpeciesDataModel, PlantListViewModel>()
            ...
            CreateMap<SpeciesDataModel, PlantNewViewModel>()
               .ForMember(uio => uio.CommonName, opt => opt.MapFrom(dm => dm.CommonName))
               .ForMember(uio => uio.Description, opt => opt.MapFrom(dm => dm.Description))
               .ForMember(uio => uio.GenusId, opt => opt.MapFrom(dm => dm.GenusId))
               .ForMember(uio => uio.Native, opt => opt.MapFrom(dm => dm.Native))
            ...
            CreateMap<SpeciesDataModel, PlantShowViewModel>()
               .ForMember(uio => uio.Binomial, opt => opt.MapFrom(dm => SpeciesFunctions.GetBinomial(dm.GenusName, dm.SpecificName)))
               .ForMember(uio => uio.CommonName, opt => opt.MapFrom(dm => dm.CommonName))
               .ForMember(uio => uio.Description, opt => opt.MapFrom(dm => dm.Description))
               .ForMember(uio => uio.Genus, opt => opt.MapFrom(dm => dm.GenusName))
        ...
        {
            // Site
            CreateMap<SiteDataModel, SiteDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
            ...
            CreateMap<SiteDataModel, SiteEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Latitude, opt => opt.MapFrom(dm => dm.Latitude))
                .ForMember(uio => uio.Longitude, opt => opt.MapFrom(dm => dm.Longitude))
                .ForMember(uio => uio.SiteName, opt => opt.MapFrom(dm => dm.SiteName))
            ...
            CreateMap<SiteDataModel, SiteListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Latitude, opt => opt.MapFrom(dm => dm.Latitude))
                .ForMember(uio => uio.Longitude, opt => opt.MapFrom(dm => dm.Longitude))
                .ForMember(uio => uio.SiteName, opt => opt.MapFrom(dm => dm.SiteName))
            ...
            CreateMap<SiteDataModel, SiteNewViewModel>()
                .ForMember(uio => uio.Latitude, opt => opt.MapFrom(dm => dm.Latitude))
                .ForMember(uio => uio.Longitude, opt => opt.MapFrom(dm => dm.Longitude))
                .ForMember(uio => uio.SiteName, opt => opt.MapFrom(dm => dm.SiteName))
                .ForMember(uio => uio.Suburb, opt => opt.MapFrom(dm => dm.Suburb));

            CreateMap<SiteDataModel, SiteShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Latitude, opt => opt.MapFrom(dm => dm.Latitude))
                .ForMember(uio => uio.Longitude, opt => opt.MapFrom(dm => dm.Longitude))
                .ForMember(uio => uio.SiteName, opt => opt.MapFrom(dm => dm.SiteName))
        ...
        {
            // PlantStockDTO
            CreateMap<PlantStockDataModel, PlantStockDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
            ...
            CreateMap<PlantStockDataModel, PlantStockEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
            ...
            CreateMap<PlantStockDataModel, PlantStockListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.QuantityInStock, opt => opt.MapFrom(dm => dm.QuantityInStock))
                .ForMember(uio => uio.SpeciesBinomial, opt => opt.MapFrom(dm => SpeciesFunctions.GetBinomial(dm.GenusName, dm.SpeciesName)))
            ...
            CreateMap<PlantStockDataModel, PlantStockNewViewModel>()
            ...
            CreateMap<PlantStockDataModel, PlantStockShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.QuantityInStock, opt => opt.MapFrom(dm => dm.QuantityInStock))
                .ForMember(uio => uio.SpeciesBinomial, opt => opt.MapFrom(dm => SpeciesFunctions.GetBinomial(dm.GenusName, dm.SpeciesName)))
        ...
        {
            // JournalEntryDTO
            CreateMap<JournalEntryDataModel, TransactionDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Notes, opt => opt.MapFrom(dm => dm.Notes))
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
            ...
            CreateMap<JournalEntryDataModel, TransactionEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Notes, opt => opt.MapFrom(dm => dm.Notes))
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
            ...
            CreateMap<JournalEntryDataModel, TransactionListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.Quantity, opt => opt.MapFrom(dm => dm.Quantity))
            ...
            CreateMap<JournalEntryDataModel, TransactionNewViewModel>()
                .ForMember(uio => uio.Notes, opt => opt.MapFrom(dm => dm.Notes))
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.Quantity, opt => opt.MapFrom(dm => dm.Quantity))
            ...
            CreateMap<JournalEntryStockSummaryDataModel, TransactionStockSummaryListViewModel>()
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.QuantityInStock, opt => opt.MapFrom(dm => dm.QuantityInStock))
            ...
            CreateMap<JournalEntryStockSummaryDataModel, TransactionStockSummaryDetailsViewModel>()
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.QuantityInStock, opt => opt.MapFrom(dm => dm.QuantityInStock))
            ...
            CreateMap<JournalEntryStockSummaryDataModel, TransactionStocktakeListViewModel>()
                .ForMember(uio => uio.SpeciesId, opt => opt.MapFrom(dm => dm.SpeciesId))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.QuantityInStock, opt => opt.MapFrom(dm => dm.QuantityInStock))
        ...
        {
            // SaleEvent
            CreateMap<SaleEventDataModel, SaleEventDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location));

            CreateMap<SaleEventDataModel, SaleEventEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location));

            CreateMap<SaleEventDataModel, SaleEventListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location));

            CreateMap<SaleEventDataModel, SaleEventNewViewModel>()
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location));

            CreateMap<SaleEventDataModel, SaleEventShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location));

            CreateMap<SaleEventDataModel, SaleEventDetailsViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
                .ForMember(uio => uio.SaleDate, opt => opt.MapFrom(dm => dm.SaleDate))
                .ForMember(uio => uio.Location, opt => opt.MapFrom(dm => dm.Location))
        ...
        {
            CreateMap<SaleEventStockDataModel, SaleEventStockListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
        ...
        {
            // ProductType
            CreateMap<ProductTypeDataModel, ProductTypeDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<ProductTypeDataModel, ProductTypeEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<ProductTypeDataModel, ProductTypeListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<ProductTypeDataModel, ProductTypeNewViewModel>()
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<ProductTypeDataModel, ProductTypeShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));
        }
        ...
        {
            // PriceListType
            CreateMap<PriceListTypeDataModel, PriceListTypeDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<PriceListTypeDataModel, PriceListTypeEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<PriceListTypeDataModel, PriceListTypeListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<PriceListTypeDataModel, PriceListTypeNewViewModel>()
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<PriceListTypeDataModel, PriceListTypeShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name));

            CreateMap<PriceListTypeDataModel, PriceListTypeDetailsViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Name, opt => opt.MapFrom(dm => dm.Name))
        ...
        {
            CreateMap<ProductPriceDataModel, ProductPriceDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
            ...
            CreateMap<ProductPriceDataModel, ProductPriceEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.PriceListTypeId, opt => opt.MapFrom(dm => dm.PriceListTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
            ...
            CreateMap<ProductPriceDataModel, ProductPriceListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.PriceListTypeId, opt => opt.MapFrom(dm => dm.PriceListTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
            ...
            CreateMap<ProductPriceDataModel, ProductPriceNewViewModel>()
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.PriceListTypeId, opt => opt.MapFrom(dm => dm.PriceListTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
                .ForMember(uio => uio.PriceListTypeName, opt => opt.MapFrom(dm => dm.PriceListTypeName))
            ...
            CreateMap<ProductPriceDataModel, ProductPriceShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.ProductTypeId, opt => opt.MapFrom(dm => dm.ProductTypeId))
                .ForMember(uio => uio.PriceListTypeId, opt => opt.MapFrom(dm => dm.PriceListTypeId))
                .ForMember(uio => uio.ProductTypeName, opt => opt.MapFrom(dm => dm.ProductTypeName))
        ...
        private void ConfigureLabelViewModels()
        {
            ...
            CreateMap<SpeciesDataModel, PlantLabelListViewModel>()
        ...
        {
            // StocktakeHeader
            CreateMap<StocktakeDataModel, StocktakeHeaderDeleteViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
            ...
            CreateMap<StocktakeDataModel, StocktakeHeaderEditViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Reference, opt => opt.MapFrom(dm => dm.Reference))
                .ForMember(uio => uio.StocktakeDate, opt => opt.MapFrom(dm => dm.StocktakeDate));

            CreateMap<StocktakeDataModel, StocktakeHeaderListViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Reference, opt => opt.MapFrom(dm => dm.Reference))
                .ForMember(uio => uio.StocktakeDate, opt => opt.MapFrom(dm => dm.StocktakeDate));

            CreateMap<StocktakeDataModel, StocktakeHeaderNewViewModel>()
                .ForMember(uio => uio.Reference, opt => opt.MapFrom(dm => dm.Reference))
                .ForMember(uio => uio.StocktakeDate, opt => opt.MapFrom(dm => dm.StocktakeDate));

            CreateMap<StocktakeDataModel, StocktakeHeaderShowViewModel>()
                .ForMember(uio => uio.Id, opt => opt.MapFrom(dm => dm.Id))
                .ForMember(uio => uio.Reference, opt => opt.MapFrom(dm => dm.Reference))
                .ForMember(uio => uio.StocktakeDate, opt => opt.MapFrom(dm => dm.StocktakeDate));
        }
