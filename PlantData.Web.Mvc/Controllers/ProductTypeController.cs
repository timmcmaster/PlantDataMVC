...
{
    public class ProductTypeController : DefaultController
    {
        ...
        {
            var item = new ProductTypeNewViewModel();
            return View(item);
        }

        // POST: /"ControllerName"/Create
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Create(ProductTypeCreateEditModel form)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Update(ProductTypeUpdateEditModel form)
        {
            //var claimsIdentity = this.User.Identity as ClaimsIdentity;
            //var userId = claimsIdentity.FindFirst("unique_user_key").Value;
        ...
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Destroy(ProductTypeDestroyEditModel form)
        {
            //var claimsIdentity = this.User.Identity as ClaimsIdentity;
            //var userId = claimsIdentity.FindFirst("unique_user_key").Value;
