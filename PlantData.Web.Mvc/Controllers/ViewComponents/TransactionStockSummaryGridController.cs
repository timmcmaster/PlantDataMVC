...
using PlantData.Web.Mvc.Controllers.Queries.Transaction;
...
{
    public class TransactionStockSummaryGridController : Controller
    {
        private readonly IMediator _mediator;

        public TransactionStockSummaryGridController(IMediator mediator)
        {
            _mediator = mediator;
        }
