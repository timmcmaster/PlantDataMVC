...
namespace PlantData.Web.Mvc.Controllers
{
    ...
    public class StocktakeHeaderController : DefaultController
    {
        private readonly IMediator _mediator;

        public StocktakeHeaderController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        {
            var item = new StocktakeHeaderNewViewModel();
            return View(item);
        }
        ...
        public async Task<ActionResult> Create(StocktakeHeaderCreateEditModel form)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Update(StocktakeHeaderUpdateEditModel form)
        {
            var failureResult = DefaultFormFailureResult();
        ...
        // POST: /Seed/Delete/5
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Destroy(StocktakeHeaderDestroyEditModel form)
        {
            var failureResult = DefaultFormFailureResult();
            var successResult = RedirectToAction("Index");
