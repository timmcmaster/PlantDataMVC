...
namespace PlantDataMVC.Web.Controllers
{
    public class GenusController : DefaultController
    {
        ...
        // GET: /"ControllerName"/Index2
        // GET: /"ControllerName"/Index2?page=4&pageSize=20&sortBy=Genus&ascending=True
        //[Authorize(Policy = AuthorizationPolicies.RequireReadUserRole)]
        public async Task<ActionResult> Index2(int? page, int? pageSize, string sortBy, bool? ascending)
        {
            // resolve parameters
            var localPage = page ?? 1;
            var localPageSize = pageSize ?? 20;
