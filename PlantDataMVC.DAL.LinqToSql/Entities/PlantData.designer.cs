...
namespace PlantDataMVC.DAL.LinqToSql.Entities
{
    ...
    partial void DeleteSeedBatch(SeedBatch instance);
		...
		public PlantDataContext() : 
				base(global::PlantDataMVC.DAL.LinqToSql.Properties.Settings.Default.PlantDataConnectionString, mappingSource)
		{
			OnCreated();
		}
