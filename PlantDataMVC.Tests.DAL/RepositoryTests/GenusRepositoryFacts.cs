...
namespace PlantDataMVC.Tests.DAL
{
    public class GenusRepositoryFacts
    {
        ...
        public void CanAddItemWithId()
        {
            ...
            {
                IRepositoryFactory repoFactory = new RepositoryFactory(plantDataFakeDBContext);
                using (IUnitOfWorkAsync uow = new UnitOfWork(plantDataFakeDBContext, repoFactory))
                {
                    // Arrange
