...
{
    public class SeedTrayDtoListQueryHandler : ListQueryHandler<SeedTrayDto>
    {
        ...
        public override async Task<IEnumerable<SeedTrayDto>> Handle(ListQuery<SeedTrayDto> query, CancellationToken cancellationToken)
        {
            bool success = true;
            string? uri = "api/SeedTray";
            IEnumerable<SeedTrayDto> fullDtoList = Enumerable.Empty<SeedTrayDto>();
            ...
            while (!String.IsNullOrEmpty(uri))
            {
                ...
                if (httpResponse.IsSuccessStatusCode)
                {
                    ...
                    fullDtoList = (fullDtoList ?? Enumerable.Empty<SeedTrayDto>()).Concat(dtoList ?? Enumerable.Empty<SeedTrayDto>());
