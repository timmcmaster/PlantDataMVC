...
public class IndexQueryHandler : IQueryHandler<IndexQuery, GridDataModel<SeedTrayGridModel>>
{
    ...
    public async Task<GridDataModel<SeedTrayGridModel>> Handle(IndexQuery query, CancellationToken cancellationToken)
    {
        ...
        else if (response.Success && response.Content != null)
        {
            ...
            var modelList = _mapper.Map<IEnumerable<SeedTrayDataModel>, List<SeedTrayGridModel>>(response.Content);

            var model = new GridDataModel<SeedTrayGridModel>(modelList,  apiPagingInfo.Page, apiPagingInfo.PageSize, apiPagingInfo.TotalCount, query.SortBy, query.SortAscending);
