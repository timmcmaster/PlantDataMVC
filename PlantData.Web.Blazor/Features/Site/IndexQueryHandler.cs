...
{
    public class IndexQueryHandler : IQueryHandler<IndexQuery, GridDataModel<SiteGridModel>>
    {
        ...
        public async Task<GridDataModel<SiteGridModel>> Handle(IndexQuery query, CancellationToken cancellationToken)
        {
            ...
            else if (response.Success && response.Content != null)
            {
                ...
                var modelList = _mapper.Map<IEnumerable<SiteDataModel>, List<SiteGridModel>>(response.Content);

                var model = new GridDataModel<SiteGridModel>(modelList, apiPagingInfo.Page, apiPagingInfo.PageSize, apiPagingInfo.TotalCount, query.SortBy, query.SortAscending);
