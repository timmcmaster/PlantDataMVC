...
namespace PlantData.Web.Mvc.Handlers.Views.ProductType
{
    public class IndexQueryHandler : IQueryHandler<IndexQuery, GridDataModel<ProductTypeGridModel>>
    {
        ...
        public async Task<GridDataModel<ProductTypeGridModel>> Handle(IndexQuery query, CancellationToken cancellationToken)
        {
            ...
            else if (response.Success && response.Content != null)
            {
                ...
                var modelList = _mapper.Map<IEnumerable<ProductTypeDataModel>, List<ProductTypeGridModel>>(response.Content);

                var model = new GridDataModel<ProductTypeGridModel>(
                    modelList,
