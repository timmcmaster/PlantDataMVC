...
{
    public class IndexQueryHandler : IQueryHandler<IndexQuery, List<GenusGridModel>>
    {
        ...
        public async Task<List<GenusGridModel>> Handle(IndexQuery query, CancellationToken cancellationToken)
        {
