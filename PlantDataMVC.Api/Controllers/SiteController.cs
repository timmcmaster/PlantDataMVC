...
namespace PlantDataMVC.Api.Controllers
{
    ...
    public class SiteController : ControllerBase
    {
        ...
        public SiteController(IUnitOfWorkAsync unitOfWorkAsync, ISiteService service, IMapper mapper, ILogger<SiteController> logger)
        {
            _service = service;
        ...
        [HttpPatch("{id}")]
        //[Authorize(Policy = AuthorizationPolicies.RequireWriteUserRole)]
        public IActionResult Patch(int id, [FromBody] JsonPatchDocument<CreateUpdateSiteDataModel> itemPatchDoc)
        {
            try
            {
