...
{
    public class PlantSpeciesDtoListViewModelHandler : ListViewModelHandler<SpeciesDto>
    {
        private readonly IMyHttpClientFactory _httpClientFactory;

        public PlantSpeciesDtoListViewModelHandler(IMyHttpClientFactory httpClientFactory)
        {
