...
{
    public class SiteDeleteViewModelHandler : IViewHandler<DeleteQuery, SiteDeleteViewModel>
    {
        ...
        public async Task<SiteDeleteViewModel> HandleAsync(DeleteQuery query)
        {
