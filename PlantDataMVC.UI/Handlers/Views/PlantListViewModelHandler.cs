...
{
    public class PlantListViewModelHandler : IViewHandler<ListViewModelStatic<PlantListViewModel>,IndexQuery>
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public PlantListViewModelHandler(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<ListViewModelStatic<PlantListViewModel>> HandleAsync(IndexQuery query)
        {
            ...
            var httpResponse = await httpClient.GetAsync("api/Species?sort=genusId,specificName&page=" + query.Page + "&pageSize=" + query.PageSize);
