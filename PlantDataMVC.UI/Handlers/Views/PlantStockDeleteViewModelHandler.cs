...
{
    public class PlantStockDeleteViewModelHandler : IViewHandler<PlantStockDeleteViewModel,ShowQuery>
    {
        ...
        public async Task<PlantStockDeleteViewModel> HandleAsync(ShowQuery query)
        {
