...
{
    public class PlantStockEditViewModelHandler : IViewHandler<EditQuery,PlantStockEditViewModel>
    {
        ...
        public async Task<PlantStockEditViewModel> HandleAsync(EditQuery query)
        {
