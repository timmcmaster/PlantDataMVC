...
{
    public class PlantStockDetailsViewModelHandler : IViewHandler<DetailsQuery, PlantStockDetailsViewModel>
    {
        ...
        public async Task<PlantStockDetailsViewModel> HandleAsync(DetailsQuery query)
        {
