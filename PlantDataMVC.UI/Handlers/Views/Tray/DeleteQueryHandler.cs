...
{
    public class DeleteQueryHandler : IQueryHandler<DeleteQuery, TrayDeleteViewModel>
    {
        ...
        public async Task<TrayDeleteViewModel> HandleAsync(DeleteQuery query, CancellationToken cancellationToken)
        {
