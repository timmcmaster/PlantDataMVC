...
{
    public class PlantSeedDeleteViewModelHandler : IViewHandler<PlantSeedDeleteViewModel,ShowQuery>
    {
        ...
        public async Task<PlantSeedDeleteViewModel> HandleAsync(ShowQuery query)
        {
