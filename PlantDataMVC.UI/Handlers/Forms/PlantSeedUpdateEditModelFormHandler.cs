...
namespace PlantDataMVC.UI.Handlers.Forms
{
    public class PlantSeedUpdateEditModelFormHandler : IFormHandler<PlantSeedUpdateEditModel>
    {
        ...
        public PlantSeedUpdateEditModelFormHandler(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<bool> HandleAsync(PlantSeedUpdateEditModel form)
        {
            try
            {
                ...
                var httpResponse = await httpClient.PutAsync("api/SeedBatch/" + form.Id, content);
